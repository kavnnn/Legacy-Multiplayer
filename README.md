# Legacy Multiplayer — Documentation

Documentation for the **Legacy Multiplayer** Lua scripting API.
...
The API documentation is currently being expanded.

The goal is to document all available:
...
Some APIs may currently be undocumented or incomplete.

---

## Repository

[Legacy-Server-Files](https://github.com/kavnnn/Legacy-Server-Files)

Documentation will be updated as the Legacy Multiplayer API continues to develop.

## License

This repository is licensed under the MIT License.

This applies to the documentation and example code contained in this repository.
